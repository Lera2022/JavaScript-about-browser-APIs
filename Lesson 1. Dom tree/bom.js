...
// userAgent - информация о браузереб
...
function calculateDistance(location1, location2) {
    ...
    return distance;    // Возвращает расстояние между местоположеними
}
            ...
            navigator.geolocation.getCurrentPosition(
                position => {
                    ...
                    cities.forEach(city => {    // Перебирает все города из массива cities
                        const distance = calculateDistance(userLocation, city.location);    // Вычисляет расстояния между местоположением пользователя и текущим городом
